export const profile = {
  name: 'Christian Hall',
  tagline: "Hi! I'm Christian, a **technology marketing professional** with 20+ years in the sector",
  summary:
    "I've worked with some of the biggest names in AI, diving deep into strategic positioning and GTM execution. From driving awareness, engagement, and pipeline across global and EMEA markets, I have delivered multi-channel programmes that educate and activate the C-suite and extended buying teams on AI-focused workloads and GPU-accelerated compute using modern global data center infrastructure.",
  about: [
...
export const contact = {
  email: 'christian.hall@gmail.com',
  linkedin: 'https://www.linkedin.com/in/christianhall/',
  github: 'https://github.com/christbt79',
